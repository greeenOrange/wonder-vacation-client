...
const RemovePackages = () => {
    ...
    //     axios.delete(`https://wondervacationserver-production.up.railway.app/packages/${id}`)
    //     .then(res => res.json())
    //      .then((data) => {
    ...
    //       })}
        ...
        // const handleDelete = id => {
        //     setIsLoading(true)
        //     const url = `https://wondervacationserver-production.up.railway.app/packages/${id}`;
        //     fetch(url, {
        //     method: 'DELETE'
        //     })
        //     .then(res => res.json())
